...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      iniciarSesion(data);
      // Redirigir según rol del objeto retornado
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ marginTop: 40, width: '100%', maxWidth: 320 }}>
          ...
          {CREDENCIALES.map(c => (
            <div
              key={c.rol}
              onClick={() => setForm({ mail: c.mail, pass: c.pass })}
              style={{
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          {error && (
            <div style={{ background: '#FCEBEB', color: '#A32D2D', borderRadius: 10, padding: '12px 16px', fontSize: 13, marginBottom: 20 }}>
              ⚠️ {error}
            </div>
          )}
